...
<head>
    ...
    <link rel="stylesheet" href="style/order_history_style.css">
...
<div class="container">
    ...
    <div class="welcome-section">
        <strong><p class="welcome-message">Welcome, <?php echo $username; ?>!</p></strong>
    ...
    <?php else: ?>
        <?php foreach ($orderHistory as $order): ?>
            <div class="order-container">
                <p><strong>Order ID:</strong> <?php echo $order['id']; ?>&emsp; &emsp; &emsp;  <strong>Date:</strong> <?php echo $order['created_at']; ?></p>
          

                <p><strong>Name:</strong> <?php echo $order['name']; ?></p>
                <p><strong>Email:</strong> <?php echo $order['email']; ?></p>
                <p><strong>Mobile:</strong> <?php echo $order['mobile']; ?></p>
                <p><strong>Address:</strong> <?php echo $order['address'] . ', ' . $order['district'] . ', ' . $order['pincode']; ?></p>
